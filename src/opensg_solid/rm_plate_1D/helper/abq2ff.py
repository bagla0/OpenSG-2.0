...
def main():
    """Build the .ff station table from an Abaqus shell field .dat.

    In:
        none -- parses sys.argv (dat path, --db) and reads the .dat and
        layup_db.yaml from disk.
    Out:
        None -- writes <dat stem>.ff next to the input .dat.
    """
