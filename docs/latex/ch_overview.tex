...
\begin{lstlisting}[style=opensg,caption={The whole contract in four lines.}]
\texttt{.out} file is written as a side effect of the call.}]
...
\begin{lstlisting}[style=opensg,caption={The msg-solid driver signature.}]
\texttt{n\_model} selects which macro strain set is built.}]
