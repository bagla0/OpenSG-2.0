...
material_param=jnp.array([(70.0e9, 70.0e9, 70.0e9,
                          26.9230769231e9, 26.9230769231e9, 26.9230769231e9,
                          0.30, 0.30, 0.30)])
...
with open("square_solid_bicg_iso.out", "w") as _f:
    ...
    for _k, _v in _rows:
        _f.write("%-5s %16.8e\n" % (_k, _v))
print("wrote square_solid_bicg_iso.out")
